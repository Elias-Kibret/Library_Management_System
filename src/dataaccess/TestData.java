...
public class TestData {
	...
	public void libraryMemberData() {
		LibraryMember libraryMember = new LibraryMember("1005", "Firanol", "Abdisa", "641-223-2211", addresses.get(4));
		members.add(libraryMember);
		libraryMember = new LibraryMember("1006", "Elias", "Kena", "702-998-2414", addresses.get(5));
		members.add(libraryMember);
		
		libraryMember = new LibraryMember("1007", "Guta", "Eba", "451-234-8811", addresses.get(6));
		members.add(libraryMember);
		
		libraryMember = new LibraryMember("1008", "Bontu", "Girma", "641-472-2871", addresses.get(7));
		members.add(libraryMember);
