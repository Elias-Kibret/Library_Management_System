...
public class DataAccessFacade implements DataAccess {
    ...
    // New methods for data manipulation and validation

    public void saveBookCopy(BookCopy copy) {
        Book book = searchBook(copy.getBook().getIsbn());
        if (book != null) {
            book.addCopy(copy);
            saveBook(book);
        }
    ...
    public void saveAuthor(Author author) {
        // Since Author is not directly saved but is part of Book,
        // this method may be used if a separate Author management system is needed.
    }
